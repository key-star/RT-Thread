...
void lcd_spi_write_command(unsigned char command)
{
    unsigned char i;

    rt_pin_write(LCD_CS_GPIO_NUM, PIN_LOW);

    rt_pin_write(LCD_SCLK_GPIO_NUM, PIN_LOW);
    rt_pin_write(LCD_MOSI_GPIO_NUM, PIN_LOW);
    rt_pin_write(LCD_SCLK_GPIO_NUM, PIN_HIGH);
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        if (command & 0x80)
        {
            rt_pin_write(LCD_MOSI_GPIO_NUM, PIN_HIGH);
        }
        else
        {
            rt_pin_write(LCD_MOSI_GPIO_NUM, PIN_LOW);
    ...
    rt_pin_write(LCD_CS_GPIO_NUM, PIN_HIGH);
}

void lcd_spi_write_data(unsigned char data)
{
    unsigned char i;
...
static rt_err_t drv_lcd_init(struct rt_device *device)
{
    ...
    /* lcd initialization, right now */
    lcd = lcd;

    rt_pin_mode(LCD_RES_GPIO_NUM, PIN_MODE_OUTPUT);
    rt_pin_mode(LCD_CS_GPIO_NUM, PIN_MODE_OUTPUT);
    rt_pin_mode(LCD_SCLK_GPIO_NUM, PIN_MODE_OUTPUT);
    rt_pin_mode(LCD_MOSI_GPIO_NUM, PIN_MODE_OUTPUT);

    rt_pin_write(LCD_RES_GPIO_NUM, PIN_HIGH);
    rt_thread_mdelay(1);
    rt_pin_write(LCD_RES_GPIO_NUM, PIN_LOW);
    rt_thread_mdelay(10);
    rt_pin_write(LCD_RES_GPIO_NUM, PIN_HIGH);
    rt_thread_mdelay(200);

    /* lcd setting */
    lcd_spi_write_command(0xFF);
    ...
    lcd_spi_write_command(0xC0);
    lcd_spi_write_data(0x3B); // 480
    lcd_spi_write_data(0x00);

    lcd_spi_write_command(0xC1);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0x02);

    lcd_spi_write_command(0xC2); // Inversion selection
    lcd_spi_write_data(0x31);    // 31 2-DOT 37-Column
    lcd_spi_write_data(0x06);

    lcd_spi_write_command(0xC3); // SET RGB MODE
    lcd_spi_write_data(0x02);    // 00-DE MODE, 80-HV MODE PCLK N
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x00);

    lcd_spi_write_command(0xCC);
    lcd_spi_write_data(0x10);
    /* gamma set */
    lcd_spi_write_command(0xB0);
    lcd_spi_write_data(0x08); // 08
    lcd_spi_write_data(0x14);
    lcd_spi_write_data(0x97);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0x13);
    ...
    lcd_spi_write_data(0x10); // 10

    lcd_spi_write_command(0xB1);
    lcd_spi_write_data(0x08); // 08
    lcd_spi_write_data(0x14);
    lcd_spi_write_data(0x97);
    lcd_spi_write_data(0x0A);
    ...
    lcd_spi_write_command(0xB0); // VOP=4.465
    lcd_spi_write_data(0x5D);

    lcd_spi_write_command(0xB1); // VCOM
    lcd_spi_write_data(0x38);    //

    lcd_spi_write_command(0xB2); // VGH
    lcd_spi_write_data(0x81);    // 12V

    lcd_spi_write_command(0xB3);
    lcd_spi_write_data(0x80);

    lcd_spi_write_command(0xB5); // VGL
    lcd_spi_write_data(0x4E);    //-12.2V

    lcd_spi_write_command(0xB7);
    lcd_spi_write_data(0x85);

    lcd_spi_write_command(0xB8);
    lcd_spi_write_data(0x20);

    lcd_spi_write_command(0xC1);
    lcd_spi_write_data(0x78);

    lcd_spi_write_command(0xC2);
    lcd_spi_write_data(0x78);

    lcd_spi_write_command(0xD0);
    lcd_spi_write_data(0x88);

    rt_thread_mdelay(100);
    /* End Power Control Registers Initial */
    /* gip set */
    lcd_spi_write_command(0xE0);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x02);

    lcd_spi_write_command(0xE1);
    ...
    lcd_spi_write_command(0xE3);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x11);
    lcd_spi_write_data(0x11);

    lcd_spi_write_command(0xE4);
    lcd_spi_write_data(0x44);
    lcd_spi_write_data(0x44);

    lcd_spi_write_command(0xE5);
    lcd_spi_write_data(0x0D);
    lcd_spi_write_data(0xF1);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);
    lcd_spi_write_data(0x0F);
    lcd_spi_write_data(0xF3);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);
    lcd_spi_write_data(0x09);
    lcd_spi_write_data(0xED);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);
    lcd_spi_write_data(0x0B);
    lcd_spi_write_data(0xEF);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);

    lcd_spi_write_command(0xE6);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x11);
    lcd_spi_write_data(0x11);

    lcd_spi_write_command(0xE7);
    lcd_spi_write_data(0x44);
    lcd_spi_write_data(0x44);

    lcd_spi_write_command(0xE8);
    lcd_spi_write_data(0x0C);
    lcd_spi_write_data(0xF0);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);
    lcd_spi_write_data(0x0E);
    lcd_spi_write_data(0xF2);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);
    lcd_spi_write_data(0x08);
    lcd_spi_write_data(0xEC);
    lcd_spi_write_data(0x10);
    lcd_spi_write_data(0xC0);
    lcd_spi_write_data(0x0A);
    ...
    lcd_spi_write_command(0xEB);
    lcd_spi_write_data(0x00);
    lcd_spi_write_data(0x01);
    lcd_spi_write_data(0xE4);
    lcd_spi_write_data(0xE4);
    lcd_spi_write_data(0x44);
    lcd_spi_write_data(0x88);
    lcd_spi_write_data(0x00);

    lcd_spi_write_command(0xED);
    ...
    lcd_spi_write_command(0x3A); // 50---RGB565,60---RGB666,70-----RGB888
    lcd_spi_write_data(0x50);

    lcd_spi_write_command(0x36);
    lcd_spi_write_data(0x00); // 00 --FW;10 ----BW

    lcd_spi_write_command(0x35);
...
static rt_err_t drv_lcd_control(struct rt_device *device, int cmd, void *args)
{
    ...
    {
        lcd_spi_write_command(0x28);
        rt_thread_mdelay(10);
        lcd_spi_write_command(0x10);
    }
    break;
